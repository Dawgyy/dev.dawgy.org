...
export function LinksSection() {
  const links = [
    ...
    { name: 'linkedIn', url: 'https://www.linkedin.com/in/alex-gerard-46b201295/' },
    ...
    <div>
      ...
      <section className="flex flex-wrap justify-between gap-8">
        {links.map((link, index) => (
          <a key={index} href={link.url} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2">
            <span>{link.name}</span>
